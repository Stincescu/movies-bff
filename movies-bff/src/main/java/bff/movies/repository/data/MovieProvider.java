...
public class MovieProvider {
    ...
    static {
        MovieDTO firstMovie = new MovieDTO(UUID.randomUUID().toString(), "blaBla1", posterUrl, 10.0);
        MovieDTO secondMovie = new MovieDTO(UUID.randomUUID().toString(), "blabla2", posterUrl, 5.0);
